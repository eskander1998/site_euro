...
<div class="wrapper">
      ...
      <div class="col-xs-12">
        <h2 class="page-header">
          <br>
              ...
              <i class="fa fa-globe"></i> <center> <?php if(isset($_GET['reservation'])) {
 ...
 $query1 = "SELECT * FROM `Facture` WHERE id_reservation=$id_reservation ";
    $result_tasks1 = mysqli_query($conn, $query1);   
    while($row = mysqli_fetch_assoc($result_tasks1)) {?> <a style="font-size: 20px" >Nom du client : </a><?php  echo $row['nom_client'];?> <br> <a style="font-size: 20px" >Agent en charge : </a> <?php  echo $row['agent'];}} ?>
...
<?php if(isset($_GET['reservation'])) {
 ...
 $query1 = "SELECT * FROM `Facture` WHERE id_reservation=$id_reservation ";
    ...
    while($row = mysqli_fetch_assoc($result_tasks1)) {?> <a style="padding-left: 550px;font-size: 20px;"> <?php  echo 'Fait le '.$row['date_facture'];?></a>  <br> <a style="padding-left: 550px;font-size: 20px;">  <?php echo 'A '.$row['lieu'];?> </a><?php }} ?>
