      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="gestionfacture.php">Factures</a>
 ...
 <div class="form-group">
        ...
        <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="date" name="date_facture" minlength="1" required oninvalid="setCustomValidity('Saisir la date')" oninput="setCustomValidity('')" class="form-control"  placeholder="Date" autofocus>
          </div>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="edit_facture.php?id=<?php echo $row['id']?>" class="btn btn-secondary">
                <i class="fas fa-marker"></i>
              </a>
              <a href="delete_facture.php?id=<?php echo $row['id']?>" class="btn btn-danger">
                <i class="far fa-trash-alt"></i>
              </a>
               <a href="pdf2.php?reservation=<?php echo $row['id_reservation']?>"  class="btn btn-success btn-block">
